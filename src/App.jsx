    ...
    <div className="bg-gray-100 font-sans min-h-screen flex flex-col items-center justify-start p-4">
      ...
      {!isAuthenticated ? (
        <div className="bg-white p-8 rounded shadow-lg border border-gray-300 max-w-md w-full mx-auto text-center mt-12">
          ...
          <p className="text-xs text-red-700 font-semibold uppercase tracking-widest mb-6">Portal Administrativo</p>
        ...
        <div className="w-full max-w-5xl">
          <header className="no-print w-full flex justify-center gap-4 mb-6">
            <button
              onClick={() => { window.location.hash = '#/admin'; setRoute('#/admin'); }}
          ...
          {route.includes('/admin') ? (
            <div className="bg-white p-6 rounded shadow border">
              <h2 className="text-xl font-bold text-slate-800 mb-4">Painel de Gestão Escolar</h2>
                  ...
                  <tbody>
                    {matriculas.map(m => (
                      <tr key={m.id} className="border-b">
                        ...
                        <td className="p-2">
                          <button onClick={() => { setCertificadoAtivo(m); window.location.hash = '#/certificado'; setRoute('#/certificado'); }} className="bg-blue-600 text-white text-[10px] px-2 py-1 rounded">Ver Certificado</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div className="bg-white p-8 rounded border-4 border-red-900 text-center cert-container">
