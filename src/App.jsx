...
export default function App() {
  ...
  // Referência para o container do Certificado
  ...
  // GERADOR PROFISSIONAL DE CERTIFICADO EM PDF (HTML2CANVAS + JSPDF)
  const handleBaixarCertificadoPDF = async () => {
    if (!certificadoRef.current) return;
    setGerandoPdf(true);

    try {
      const element = certificadoRef.current;
      const paginas = element.querySelectorAll('.pagina-cert');

      // Instancia PDF em formato A4 Horizontal
      const pdf = new jsPDF('landscape', 'mm', 'a4');

      for (let i = 0; i < paginas.length; i++) {
        const canvas = await html2canvas(paginas[i], {
          scale: 2, // Maior resolução e nitidez
          useCORS: true,
          logging: false
        });
      ...
      const nomeArquivo = `Certificado_${cursoVisualizar.alunoDados?.nome?.replace(/\s+/g, '_') || 'Aluno'}.pdf`;
  ...
  if (route === '#/admin') {
    ...
    return (
      <div style={styles.containerAdmin}>
              ...
              <div style={styles.modalContentAmpliado}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '14px 0', backgroundColor: '#0f172a', padding: '12px 16px', borderRadius: '8px', border: '1px solid #334155' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <button
                      onClick={handleBaixarCertificadoPDF}
                      disabled={gerandoPdf || !(Number(cursoVisualizar.nota) >= 6 || cursoVisualizar.status === 'Concluído')}
                      style={{
                        ...styles.btnAdmin,
                    ...
                    >
                      {gerandoPdf ? '⏳ Gerando PDF...' : '🎓 Baixar Certificado (PDF)'}
                    </button>
                  </div>
                </div>
        ...
        {/* CONTAINER DO CERTIFICADO FORA DA TELA PARA CAPTURA DO PDF */}
        {cursoVisualizar && (
          <div style={{ position: 'absolute', left: '-9999px', top: '-9999px' }}>
            <div ref={certificadoRef}>
              {/* PÁGINA 1: FRENTE DO CERTIFICADO */}
              <div className="pagina-cert" style={certStyles.pagina}>
                <div style={certStyles.bordaExterna}>
                  <div style={certStyles.bordaInterna}>
                    ...
                    <div style={certStyles.boxInfo}>
                      ...
                      <div>SITUAÇÃO: <strong style={{ color: '#15803d' }}>APROVADO</strong></div>
                    </div>
              ...
              {/* PÁGINA 2: VERSO COM CONTEÚDO PROGRAMÁTICO */}
              <div className="pagina-cert" style={certStyles.pagina}>
                <div style={certStyles.bordaExterna}>
                  <div style={certStyles.bordaInterna}>
...
// DIMENSÕES DIMENSIONADAS EXATAMENTE PARA A4 LANDSCAPE (297mm x 210mm)
const certStyles = {
...
// Estilos base do certificado (com base no seu código visualizado no VS Code)
const certStyles = {
  container: {
    padding: '20px',
    backgroundColor: '#fff',
...
export default function App() {
  ...
  // Função para gerar e baixar o PDF em orientação Paisagem (Landscape)
    ...
    <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div ref={certRef} style={certStyles.container}>
        <div style={certStyles.borderInner}>
          ...
          <h1 style={{ fontSize: '24px', letterSpacing: '1px', marginBottom: '10px', color: '#1e3a8a' }}>
            MAZZ CURSOS & CAPACITAÇÕES
          </h1>

          <h3 style={{ color: '#c2410c', textTransform: 'uppercase', marginBottom: '25px' }}>
          ...
          <h2 style={{ fontSize: '26px', color: '#000', margin: '15px 0', textTransform: 'uppercase' }}>
            KESIA MARIA
          </h2>
          ...
          <h3 style={{ fontSize: '20px', color: '#1e3a8a', textTransform: 'uppercase', marginBottom: '25px' }}>
          ...
          <div style={certStyles.linhaAssinatura}>
            ...
            <div style={certStyles.assinatura}>
              ...
              <small style={{ fontSize: '10px', color: '#555' }}>CNPJ: 68.664.946/0001-96</small>
            </div>
